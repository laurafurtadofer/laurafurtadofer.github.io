...
```{r, how many times does joey say How you doin per season}
...
```{r, how many times do they say smelly cat in the show vs number of phoebe lines, attr.message= FALSE, attr.warning= FALSE}
...
ggplot(smelly_cats_char, aes(x = total_utterances, y = total_smelly_cats)) + 
  ...
  labs(
    title = "Character Utterances vs. 'Smelly Cat' Mentions",
    x = "Total Utterances",
    y = "Total 'Smelly Cat' Mentions",
    colour = "Speaker"
  ) +
  theme_minimal()
...
```{r, who talks to and about Janice the most}
